...
export default {
  ...
  methods: {
    ...
    handleData(data) {
      __tool.setLocalStorage('agency_token', data.agency_token)
      // __tool.setLocalStorage('agency_id', data.token_info.agency_id)
      __tool.setLocalStorage('manage_id', data.manage_id)
